...
namespace PuttingTheTInTerraria.Content.Items.Consumables
{
	...
	public class MassTSummonItem : ModItem
	{
		...
		public override bool CanUseItem(Player player) {
			...
			return !NPC.AnyNPCs(ModContent.NPCType<MassTHead>());
		}
		...
		public override bool? UseItem(Player player) {
			if (player.whoAmI == Main.myPlayer) {
				...
				int type = ModContent.NPCType<MassTHead>();

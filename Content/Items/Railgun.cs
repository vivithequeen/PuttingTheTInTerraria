...
namespace PuttingTheTInTerraria.Content.Items
{
	public class Railgun : ModItem
	{
		public override void SetDefaults() {
            ...
            /*
			Item.UseSound = new SoundStyle($"{nameof(PuttingTheTInTerraria)}/Assets/Sounds/Items/Guns/ExampleGun") {
				Volume = 0.9f,
				PitchVariance = 0.2f,
				MaxInstances = 3,
			};
            */
			...
			Item.shootSpeed = 30f; // The speed of the projectile (measured in pixels per frame.) This value equivalent to Handgun
		}
		...
		public override void ModifyShootStats(Player player, ref Vector2 position, ref Vector2 velocity, ref int type, ref int damage, ref float knockback) {
			...
			type = ModContent.ProjectileType<Projectiles.Spike>();
		}

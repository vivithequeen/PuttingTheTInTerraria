...
namespace PuttingTheTInTerraria.Content.Items
{
	...
	public class Wheel : ModItem
	{
		public override void SetStaticDefaults() {
			...
			ItemID.Sets.ToolTipDamageMultiplier[Type] = 100f;
		}

		public override void SetDefaults() {
			Item.useStyle = ItemUseStyleID.Shoot; // How you use the item (swinging, holding out, etc.)
			Item.useAnimation = 100; // The item's use time in ticks (60 ticks == 1 second.)
			...
			Item.damage = 450; // The damage of your flail, this is dynamically adjusted in the projectile code.
			Item.noUseGraphic = true; // This makes sure the item does not get shown when the player swings his hand
            Item.shoot = ModContent.ProjectileType<Projectiles.WheelProj>(); // The flail projectile
			Item.shootSpeed = 600f; // The speed of the projectile measured in pixels per frame.
			Item.UseSound = SoundID.Item1; // The sound that this item makes when used
			Item.rare = ItemRarityID.Red; // The color of the name of your item
			Item.value = Item.sellPrice(platinum: 1); // Sells for 1 gold 50 silver
